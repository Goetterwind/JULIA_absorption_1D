...
% spatial), informations about the intensity field (pump or pulse) and the
% doping-gradient (given externally)
% 
% version with multi-spectral components

function [beta_crystal,beta_store,pulse,Ntot_gradient]=beta_int_ms(beta_crystal,pulse,const,crystal,steps,int_field,mode,Ntot_gradient)
